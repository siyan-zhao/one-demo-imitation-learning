...
class SAC(OffPolicyRLModel):
    ...
    def train_step(self, replay_buffer, training_steps, total_training_timesteps, total_training_steps_done_so_far,
        ...
        for step in range(training_steps):
            ...
            for grad_step in range(self.gradient_steps):
                ...
                frac = 1.0 - (step + total_training_steps_done_so_far) / total_training_timesteps
                #if step == 0:
                #    print(frac)
        ...
        if len(mb_infos_vals) > 0:
            mb_infos_vals = np.array(mb_infos_vals)
